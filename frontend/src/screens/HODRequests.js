...
const HODRequests = ({ navigation }) => {
    ...
    const fetchRequests = async () => {
        try {
            const res = await api.get('/requests/hod-list');
    ...
    const submitAction = async () => {
        try {
            await api.post('/requests/hod-action', {
    ...
    const renderRequestItem = ({ item }) => (
        <View style={styles.card}>
            ...
            <View style={styles.coordinatorRemarks}>
                <Text style={styles.remarksLabel}>Coordinator Action: Approved</Text>
                {item.coordinatorRemarks && <Text style={styles.remarksText}>Note: {item.coordinatorRemarks}</Text>}
            </View>
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <LinearGradient colors={['#800000', '#5a0000']} style={styles.header}>
                ...
                <Text style={styles.headerSub}>Department Final Reviews</Text>
            </LinearGradient>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <TextInput
                            ...
                            placeholder="Add final remarks for the student..."
                            multiline
                            numberOfLines={4}
                        ...
                        <View style={styles.modalActions}>
                            ...
                            >
                                <Text style={styles.submitText}>Confirm {actionType}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    studentInfo: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
